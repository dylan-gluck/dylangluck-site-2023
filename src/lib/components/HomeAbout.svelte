	...
	<div class="py-10 mx-auto">
		<div class="p-6 md:max-w-2xl xl:max-w-3xl">
			...
			<p class="md:my-4">
				...
				volutpat mea an, et nec discere epicuri
			</p>
		</div>
		<div class="grid grid-cols-5 p-6">
			...
			>
				...
				>
				<button
					class="px-2 py-1 border-b-2 md:border-l-2 md:border-b-0 md:py-3 border-primary text-base-content"
					>Fabellas</button
				>
				<button
			...
			<div class="grid gap-12 py-4 sm:grid-cols-2 col-span-full md:col-span-4">
				<div
					class="flex flex-col items-start justify-center space-y-3 md:justify-start md:items-start"
				>
					<svg
						fill="none"
						stroke="currentColor"
				...
				>
					...
					<p>
						Et eos atomorum urbanitas accommodare, in suscipit petentium vis. Pro ea nibh praesent
						postulant.
					</p>
				</div>
				<div
				...
				>
					...
					<p>
						Eu vis urbanitas scripserit, civibus scripserit pro id. Omnes congue contentiones te
						eos.
					</p>
				</div>
			</div>
